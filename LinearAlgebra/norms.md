 ...
 * In our problem it would be <img src="https://latex.codecogs.com/svg.image?{\color{Purple}\mathbf{\parallel&space;v\parallel_\infty=&space;|5|,\&space;|3|,\&space;|2|}&space;=&space;5}&space;&space;" title="https://latex.codecogs.com/svg.image?{\color{Purple}\mathbf{\parallel v\parallel_\infty= |5|,\ |3|,\ |2|} = 5} " align="center"/>
