...
* So, let us say this $\large{\color{Purple}\mathrm{A_{3 \times 3}}}$ is longer you had  you would still look at only $\large{\color{Purple}\mathrm{A_{ii}}}$  which are $\large{\color{Purple}\mathrm{A_{11},A_{22},A_{33}}}$ it would still be $\large{\color{Purple}6}$ .
