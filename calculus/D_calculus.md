...
<p align="center">
  <img src="https://latex.codecogs.com/svg.image?\LARGE&space;{\color{Purple}\begin{array}{l@{\:=\:}*{1}{l@{}}l}\frac{{d}&space;}{{d}&space;x}&space;{1}&0&space;\\\frac{{d}&space;}{{d}&space;x}&space;{x}&1&space;\\\frac{{d}&space;}{{d}&space;x}&space;{x^2}&{2x}&space;\\&space;\frac{{d}&space;}{{d}&space;x}&space;{x^n}&{nx^{n-1}}&space;\\\frac{{d}&space;}{{d}&space;x}&space;{2x}&{2&space;*&space;1}&space;\\\frac{{d}&space;}{{d}&space;x}&space;{(1&plus;x^2)}&{0&plus;2x=2x}&space;\\\frac{{d}&space;}{{d}&space;x}&space;{(1-x^2)}&{0-2x=-2x}&space;\\&space;\frac{{d}&space;}{{d}&space;x}&space;{e^x}&{e^x*&space;1=e^x}&space;\\&space;\frac{{d}&space;}{{d}&space;x}&space;{e^{f(x)}}&{e^{f(x)}}\frac{{d}&space;}{{d}&space;x}{f(x)}&space;\\\frac{{d}&space;}{{d}&space;x}&space;{\sin&space;x}&{\cos&space;x}&space;\\\frac{{d}&space;}{{d}&space;x}{\cos&space;x}&&space;{-\sin&space;x}&space;\\\frac{{d}&space;}{{d}&space;x}{\tan&space;x}&&space;{\sec^2&space;x}&space;\\\frac{{d}&space;}{{d}&space;x}{\tan^{-1}&space;x}&&space;{\frac{1}{1&plus;x^2}}&space;\\&space;\end{array}}&space;" title="https://latex.codecogs.com/svg.image?\LARGE {\color{Purple}\begin{array}{l@{\:=\:}*{1}{l@{}}l}\frac{{d} }{{d} x} {1}&0 \\\frac{{d} }{{d} x} {x}&1 \\\frac{{d} }{{d} x} {x^2}&{2x} \\ \frac{{d} }{{d} x} {x^n}&{nx^{n-1}} \\\frac{{d} }{{d} x} {2x}&{2 * 1} \\\frac{{d} }{{d} x} {(1+x^2)}&{0+2x=2x} \\\frac{{d} }{{d} x} {(1-x^2)}&{0-2x=-2x} \\ \frac{{d} }{{d} x} {e^x}&{e^x* 1=e^x} \\ \frac{{d} }{{d} x} {e^{f(x)}}&{e^{f(x)}}\frac{{d} }{{d} x}{f(x)} \\\frac{{d} }{{d} x} {\sin x}&{\cos x} \\\frac{{d} }{{d} x}{\cos x}& {-\sin x} \\\frac{{d} }{{d} x}{\tan x}& {\sec^2 x} \\\frac{{d} }{{d} x}{\tan^{-1} x}& {\frac{1}{1+x^2}} \\ \end{array}} " align="left"/> 
  <img src="https://latex.codecogs.com/svg.image?\LARGE&space;{\color{Purple}\begin{array}{l@{\:=\:}*{1}{l@{}}l}\frac{{d}&space;}{{d}&space;x}{\sin^{-1}&space;x}&&space;{\frac{1}{\sqrt{1&plus;x^2}&space;}}&space;\\\frac{{d}&space;}{{d}&space;x}&space;{\sin&space;f(x)}&{\cos&space;f(x)*}\frac{{d}&space;}{{d}&space;x}{f(x)}&space;\\\frac{{d}&space;}{{d}&space;x}&space;{\cos&space;f(x)}&{-\sin&space;f(x)*}\frac{{d}&space;}{{d}&space;x}{f(x)}&space;\\\frac{{d}&space;}{{d}&space;x}&space;{\left&space;[&space;f(x)&space;\right&space;]^n}&&space;{n\left&space;[&space;f(x)&space;\right&space;]^{n-1}&space;*}\frac{{d}&space;}{{d}&space;x}&space;{&space;f(x)}&space;\\\frac{{d}&space;}{{d}&space;x}&space;{\cos^{-1}}x&&space;-\frac{1}{{\sqrt{1&plus;x^2}&space;}&space;}&space;\\&space;\frac{{d}&space;}{{d}&space;x}&space;{\log}x&&space;\frac{1}{x}&space;\\&space;\frac{{d}&space;}{{d}&space;x}&space;\frac{1}{{x}}&{-\frac{1}{x^2}}\because&space;\left&space;(&space;\frac{1}{x}=x^{-1}\right&space;){&space;(-1*x^{-1-1})}&space;\\&space;\frac{\mathrm{d}&space;}{\mathrm{d}&space;x}&space;\mathrm{\cot&space;x}&\mathrm{-cosec^2&space;x}&space;\\\frac{\mathrm{d}&space;}{\mathrm{d}&space;x}&space;\mathrm{\sec&space;x}&\mathrm{\sec&space;x&space;\tan&space;x}&space;\\\frac{\mathrm{d}&space;}{\mathrm{d}&space;x}&space;\mathrm{\csc&space;x}&\mathrm{-\csc&space;x&space;\cot&space;x}&space;\\\end{array}}&space;" title="https://latex.codecogs.com/svg.image?\LARGE {\color{Purple}\begin{array}{l@{\:=\:}*{1}{l@{}}l}\frac{{d} }{{d} x}{\sin^{-1} x}& {\frac{1}{\sqrt{1+x^2} }} \\\frac{{d} }{{d} x} {\sin f(x)}&{\cos f(x)*}\frac{{d} }{{d} x}{f(x)} \\\frac{{d} }{{d} x} {\cos f(x)}&{-\sin f(x)*}\frac{{d} }{{d} x}{f(x)} \\\frac{{d} }{{d} x} {\left [ f(x) \right ]^n}& {n\left [ f(x) \right ]^{n-1} *}\frac{{d} }{{d} x} { f(x)} \\\frac{{d} }{{d} x} {\cos^{-1}}x& -\frac{1}{{\sqrt{1+x^2} } } \\ \frac{{d} }{{d} x} {\log}x& \frac{1}{x} \\ \frac{{d} }{{d} x} \frac{1}{{x}}&{-\frac{1}{x^2}}\because \left ( \frac{1}{x}=x^{-1}\right ){ (-1*x^{-1-1})} \\ \frac{\mathrm{d} }{\mathrm{d} x} \mathrm{\cot x}&\mathrm{-cosec^2 x} \\\frac{\mathrm{d} }{\mathrm{d} x} \mathrm{\sec x}&\mathrm{\sec x \tan x} \\\frac{\mathrm{d} }{\mathrm{d} x} \mathrm{\csc x}&\mathrm{-\csc x \cot x} \\\end{array}} " align="right"/>
</p>
